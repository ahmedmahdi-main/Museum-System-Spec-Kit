    ...
    IAuditActorContext actorContext)
{
    public async Task<UseCaseResult<DocumentationRecordSummaryDto>> CompleteDocumentationRecord(CompleteDocumentationRecordRequest request, CancellationToken cancellationToken = default)
    {
        ...
        {
            return DocumentationConcurrencyHandler.StaleRequest<DocumentationRecordSummaryDto>("Documentation Record changed. Reload and review the latest Draft before completing.");
        }
        ...
        catch (DbUpdateConcurrencyException ex)
        {
            return DocumentationConcurrencyHandler.OptimisticWriteConflict<DocumentationRecordSummaryDto>(
                dbContext,
                ex,
                "Documentation Record changed. Reload and review the latest Draft before completing.");
        }
